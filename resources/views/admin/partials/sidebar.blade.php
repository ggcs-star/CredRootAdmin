<aside class="w-72 bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900 text-white shadow-2xl flex flex-col h-screen sticky top-0 flex-shrink-0 overflow-hidden">

    <!-- Logo -->
    <div class="flex items-center gap-3 px-6 h-20 border-b border-white/10">

        <div class="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30">
    ...
    <div class="border-t border-white/10 p-4">
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-sm font-bold text-white shadow-lg shadow-blue-500/30">
